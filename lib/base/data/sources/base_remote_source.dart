...
import 'package:crypto_assessment/base/data/models/base_response.dart';
import 'package:crypto_assessment/base/data/models/token_type.dart';
import 'package:crypto_assessment/base/networking/http_client.dart';
import 'package:crypto_assessment/base/networking/network_exceptions.dart';
...
extension ResponseExtensions on Future<Response<dynamic>> {
  Future<R> mapToResult<R>(
    ...
    final BaseResponse responseData = BaseResponse.fromJson(it.data, (json) => json);
